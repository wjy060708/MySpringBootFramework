				...
				<div class="toolbar" id="toolbar">
					...
					<div class="ctrl-div">
						<a href="#" id="barNew" class="easyui-linkbutton" iconCls="icon-add" plain="true">新建</a>
				   		...
				   		<a href="#" id="barExecute" class="easyui-linkbutton" iconCls="icon-refresh" plain="true">激活</a>
				   		<a href="#" id="barStop" class="easyui-linkbutton" iconCls="icon-refresh" plain="true">挂起</a>
		...
		<script type="text/javascript">
			...
			$(function() {
				$("#dataGrid").datagrid({
					...
					url : '${request.contextPath}/epm/project/info/listPage.htm',
				...
				$('#barNew').click(function() {
					$.easyui.showDialog({
	                    ...
	                    href:'${request.contextPath}/epm/project/info/new.htm',
	                    ...
	                    onSave: function (d) {
	                    	...
	                    	if(validate) {
	                    		d.form(
	                    			'submit', {
	                    				url: '${request.contextPath}/epm/project/info/save.jsn',
				...
				$('#barEdit').click(function() {
					...
					if(dataRow != null) {
						...
						EditObjectEntity(projectId);
					} else {
						$.easyui.messager.alert('提示','请选择需要编辑的项目!','info');
					}	
				});
			...
			$('#barExecute').click(function() {
					var dataRow = $("#dataGrid").datagrid("getSelected");
					if(dataRow != null) {
						var projectId = dataRow['projectId'];
						
						var url = '${request.contextPath}/epm/project/info/projectStart.jsn';
						...
						$.easyui.messager.alert('提示','请选择需要发布的项目!','info');
					}
				});
				...
				$('#barStop').click(function() {
					...
					if(dataRow != null) {
						...
						var url = '${request.contextPath}/epm/project/info/projectStop.jsn';
						...
						$.easyui.messager.alert('提示','请选择需要挂起的项目!','info');
					}
				});
			
			function EditObjectEntity(projectId) {
				$.easyui.showDialog({
					title: '编辑项目',
                    ...
                    href:'${request.contextPath}/epm/project/info/edit.htm',
                    queryParams: {
                    	projectId: projectId
				    },
                    ...
                    onSave: function (d) {
                    	...
                    	if(validate) {
                    		d.form(
                    			'submit', {
                    				url: '${request.contextPath}/epm/project/info/update.jsn',
                    				success: function(response) {
    									if(response) {
    										$.easyui.messager.alert('提示', response.message, 'info');
    										if(response.success) {
