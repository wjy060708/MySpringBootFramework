	...
	<body>
	    ...
	    <div id="mainLayout" class="easyui-layout hidden" data-options="fit: true">
			<div data-options="region: 'center', border: false" style="padding: 5px;">
				<table id="dataGrid" title="项目过程管理" toolbar="#toolbar"></table>
			
				   <div class="toolbar" id="toolbar">
					<div class="search-div">
						<label>过程名称:</label>
						<input id="txtProcessName" class="easyui-textbox" type="text" />
		...
		<script type="text/javascript">
			...
			$(function() {
				$("#dataGrid").datagrid({
					...
					url : '${request.contextPath}/knowledge/process/listPage.htm',
				...
				$('#barNew').click(function() {
					$.easyui.showDialog({
	                    ...
	                    href:'${request.contextPath}/knowledge/process/new.htm',
	                    ...
	                    onSave: function (d) {
	                    	...
	                    	if(validate) {
	                    		d.form(
	                    			'submit', {
	                    				url: '${request.contextPath}/knowledge/process/save.jsn',
				...
				$('#barEdit').click(function() {
					...
					if(dataRow != null) {
						var processId = dataRow['processId'];
						EditObjectEntity(processId);
					} else {
			...
			function EditObjectEntity(processId) {
				$.easyui.showDialog({
					title: '编辑过程类型',
                    ...
                    href:'${request.contextPath}/knowledge/process/edit.htm',
                    queryParams: {
                    	processId: processId
				    },
                    ...
                    onSave: function (d) {
                    	...
                    	if(validate) {
                    		d.form(
                    			'submit', {
                    				url: '${request.contextPath}/knowledge/process/update.jsn',
                    				success: function(response) {
    									if(response) {
    										$.easyui.messager.alert('提示', response.message, 'info');
    										if(response.success) {
			...
			function DeleteObjectEntity(dataRows) {
	            ...
	            $.each(dataRows, function(i, dataRow) {
	            	processIds.push(dataRow['processId']);
	            });
		            
				$.ajax({
					type : 'post',
					url : '${request.contextPath}/knowledge/process/delete.jsn',
					data : {
