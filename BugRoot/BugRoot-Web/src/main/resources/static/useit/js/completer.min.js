...
//        })
    ...
    var _locateSearchView = function(){
        if(this.option.listDirection === 'down'){
            ...
            throw '遇到未知的listDirection参数＄1�7';
        }
    ...
    var _search = function(){
        ...
        if (loadDataFlag){
            if ($.isArray(this.option.data)) {
                ...
                _error.apply(this, ['遇到未知的data参数＄1�7']);
                return;
            }
        }
        ...
        $.each(data, function(index, value){
            ...
            if($.isPlainObject(value)){
                ...
                _error.apply(that, ['数据源Item类型错误＄1�7']);
                return false;
            }
        ...
        if ($.isPlainObject(option)) {
            ...
            switch(option){
                ...
                case 'show':
                    ...
                    break;
                default:
                    _error.apply(this, ['未知的AutoComplete参数＄1�7']);
                    return;
            }
        } else {
            _error.apply(this, ['未知的AutoComplete参数类型＄1�7']);
            return;
        }
    };
