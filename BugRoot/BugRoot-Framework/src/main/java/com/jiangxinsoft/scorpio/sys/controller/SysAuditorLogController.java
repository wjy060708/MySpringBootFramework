...
@RequestMapping("/sys/log/auditor")
@Controller
public class SysAuditorLogController {
	...
	public ModelAndView page() {
		...
		modelAndView.setViewName("sys/log/auditor/default");
	...
	public PageInfo<SysLog> listPage(LogVo sysLogVo, int page, int rows, String sort, String order) {
		PageInfo<SysLog> retPage = sysLogService.getAuditLogPage(sysLogVo, page, rows, sort, order);
		return retPage;
	}
