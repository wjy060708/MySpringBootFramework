...
public class SysAdminLogController {
	...
	public ModelAndView page() {
		...
		modelAndView.setViewName("sys/log/admin/default");
	...
	public PageInfo<SysLog> listPage(LogVo sysLogVo, int page, int rows, String sort, String order) {
		PageInfo<SysLog> retPage = sysLogService.getAdminLogPage(sysLogVo, page, rows, sort, order);
		return retPage;
	}
